...
import type {TSolutionPageLayout} from "@/types";
...
// Taxes page
export const taxesPageContent: TSolutionPageLayout = {
  textImage: {
...
// Corporate page
export const corporatePageContent: TSolutionPageLayout = {
  textImage: {
  ...
  list: [
  {
    ...
    text: `Green tax credits are generated by clean energy and other climate-friendly assets in the United States,
           including solar, wind, and carbon capture. By buying these credits through Evergrow, you provide critical 
...
// Sponsors page
export const sponsorsPageContent: TSolutionPageLayout = {
  textImage: {
...
// Contractors page
export const contractorsPageContent: TSolutionPageLayout = {
  textImage: {
  heading: `A green investment that makes a lot of cents.`,
  ...
  },
  {
    ...
    text: `Tax credits can be paid to the IRS directly instead of cash. By buying these credits at a discount to their
           face value through Evergrow, you can achieve significant savings on your taxes, earn high yields on your
           balance sheet, and boost after-tax cash flow`
  },
  {
    img: solarPower,
    title: "Lead on climate",
